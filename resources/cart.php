    ...
    foreach($_SESSION as $name=>$value){
        if($value>0){
            ...
            <tr>
                ...
                <td>{$value}</td>
                <td>&#36;{$sub}</td>
                <td><a class="btn btn-warning" href="../resources/cart.php?remove={$row["product_id"]}"><span class="glyphicon glyphicon-minus"></span></a>   <a class="btn btn-warning" href="../resources/cart.php?add={$row["product_id"]}"><span class="glyphicon glyphicon-plus"></span></a>
